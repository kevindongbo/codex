...
try {
  ...
  assert.deepEqual(errors, []);
  console.log('PASS: real clicks cross-warehouse UUID save/blank safety; purchase blank save, later two-way tracking edit/reopen, shared international grouping; pageerror=0 console.error=0');
} finally {
  await browser.close();
