...
test("versions browser assets so production never mixes new markup with cached scripts", async () => {
  ...
  assert.match(html, /styles\.css\?v=20260716-tiktok-my-monitor-1/);
  assert.match(html, /team\.js\?v=20260716-tiktok-my-monitor-1/);
  assert.match(html, /app\.js\?v=20260716-tiktok-my-monitor-1/);
