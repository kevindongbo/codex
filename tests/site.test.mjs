...
test("versions browser assets so production never mixes new markup with cached scripts", async () => {
  ...
  assert.match(html, /styles\.css\?v=20260729-profit-input-layout-7/);
  assert.match(html, /team\.js\?v=20260728-profit-calculator-server-1/);
  assert.match(html, /profit-calculator\.js\?v=20260729-profit-input-layout-7/);
  assert.match(html, /app\.js\?v=20260729-profit-input-layout-7/);
